...
export const Create = () => {
    ...
    useEffect(async () => {
        await Forms.clothForm().then(res => setForm(res)).catch(err => navigate('../'))
        notikaFormStyles(
    ...
    return (
        <>
            <h3 className="page-title">Create Cloth</h3>
            ...
            <div className="row">
                ...
                <div className="col-lg-4 col-md-5 col-sm-6 col-xs-12">
                    <RecentAdded data={data.clothes.slice(0, 3)} keys={{ name: 'color category', desc: 'added' }} />
                </div>
            </div>
        </>
    )
